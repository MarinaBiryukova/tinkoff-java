...
import ru.tinkoff.edu.domain.jooq.tables.records.ChatLinkRecord;
...
public class ChatLink extends TableImpl<ChatLinkRecord> {
     ...
     */
    public final TableField<ChatLinkRecord, Integer> ID =
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function3<? super Integer, ? super Long, ? super Long, ? extends U> from
    ) {
