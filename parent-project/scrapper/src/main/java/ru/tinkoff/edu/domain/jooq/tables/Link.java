...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> LINK_ =
        createField(DSL.name("LINK"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_ACTIVITY =
        createField(DSL.name("LAST_ACTIVITY"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>LINK.OPEN_ISSUES_COUNT</code>.
     */
    public final TableField<LinkRecord, Integer> OPEN_ISSUES_COUNT =
        createField(DSL.name("OPEN_ISSUES_COUNT"), SQLDataType.INTEGER, this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function6<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super Integer, ? super Integer, ? extends U> from
    ) {
